      ...
      <div className="container-main">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-400">
              <li className="flex items-start gap-2">
                ...
                <span>Tianhe District, Guangzhou, China</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-primary-light" />
                <a href="tel:+862038881888" className="hover:text-primary-light transition-colors">
                  +86 20 3888 1888
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-primary-light" />
                <a href="mailto:info@heihezdrav.com" className="hover:text-primary-light transition-colors">
                  info@heihezdrav.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <MessageCircle className="w-4 h-4 text-primary-light" />
                <span>WeChat: heihezdrav2024</span>
              </li>
              <li className="flex items-center gap-2">
                <MessageCircle className="w-4 h-4 text-secondary" />
                <a href="https://wa.me/8613888881888" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors">
                  WhatsApp: +86 138 8888 1888
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://facebook.com/heihezdrav" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-primary-light transition-colors">
                Facebook
              </a>
              <a href="https://instagram.com/heihezdrav" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-primary-light transition-colors">
                Instagram
              </a>
              <a href="https://weixin.qq.com/" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-secondary transition-colors">
                WeChat
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-neutral-800 pt-8 text-center text-sm text-neutral-500">
          ...
          <p>
            ...
            {" | "}
            <a href="/terms" className="hover:text-neutral-300 transition-colors">{t("footer.terms")}</a>
          </p>
        </div>
      </div>
    </footer>
